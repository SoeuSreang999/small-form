!(function (t, n) {
    ...
    const n = function (n) {
        ...
        if (o(n.id)) {
            ...
            e.node = n.parentNode;
        } else if (((e.node = document.getElementById(n.id)), !e.node))
            return !1;
        ...
        !1 !== c &&
            ...
            !0 === e.config.relativeGaugeSize
                ...
                : ((u =
                      1 *
                      m(document.getElementById(e.config.id), "width").slice(
                          0,
                          -2
                      )),
                  (d =
            ...
            (e.canvas.customAttributes.pki = function (t, n) {
                ...
                if ((i < 0 && !n && ((o -= i), (t -= i), (i = 0)), s))
                    return (
                        ...
                        (u =
                            (g = a / 2 - a / 30) - (a / 6.666666666666667) * f),
                        (p = l / 2 + c),
                ...
                if (n) {
                    (m = (1 - (t - i) / (o - i)) * Math.PI),
                        (u =
                            (g = a / 2 - a / 10) - (a / 6.666666666666667) * f),
                        (p = l / 1.25 + c),
                        (b = (d = a / 2 + r) + g * Math.cos(m)),
                        (M = p - g * Math.sin(m)),
                        (v = d + u * Math.cos(m)),
            ...
            (e.level = e.canvas
                ...
                .attr({
                    ...
                    fill: a(
                        e.config.value,
                        (e.config.value - e.config.min) /
                            (e.config.max - e.config.min),
        ...
        e.config.reverse && (L = e.config.max),
            ...
            e.txtMin.attr({
                ...
                fill: e.config.labelFontColor,
                "fill-opacity":
                    e.config.hideMinMax || e.config.donut ? "0" : "1",
            }),
        ...
        if (
            ((void 0 !== g && g < 9) ||
                (void 0 !== g
                    ...
                    : e.generateShadow(Y, k)),
            e.config.textRenderer &&
            !1 !== e.config.textRenderer(e.originalValue)
            ...
            const t = function () {
                    ...
                    e.config.reverse &&
                        (t =
                            1 * e.config.max +
                            1 * e.config.min -
                            1 * e.level.attr("pki")[0]),
                        e.config.textRenderer &&
                        !1 !== e.config.textRenderer(Math.floor(t))
                            ? e.txtValue.attr(
                                  "text",
                                  e.config.textRenderer(Math.floor(t))
                              )
                            : e.config.humanFriendly
                            ? e.txtValue.attr(
                                  "text",
                                  f(
                                      Math.floor(t),
                                      e.config.humanFriendlyDecimal
                                  ) + e.config.symbol
                              )
                            : e.config.formatNumber
                            ? e.txtValue.attr(
                                  "text",
                                  s(Math.floor(t)) + e.config.symbol
                              )
                            : e.config.displayRemaining
                            ? e.txtValue.attr(
                                  "text",
                                  (1 * (e.config.max - t)).toFixed(
                                      e.config.decimals
                                  ) + e.config.symbol
                              )
                            : e.txtValue.attr(
                                  "text",
                                  (1 * t).toFixed(e.config.decimals) +
                                      e.config.symbol
                              ),
                        l(e.txtValue, e.params.valueFontSize, e.params.valueY),
                        (t = null);
    ...
    function a(t, n, e, i, o) {
        ...
        if (0 === n)
            return (
                "rgb(" +
                [v[0].color.r, v[0].color.g, v[0].color.b].join(",") +
                ")"
            );
        for (let t = 0; t < v.length; t++)
            if (n <= v[t].pct)
                return i
                    ? "rgb(" +
                          [v[t].color.r, v[t].color.g, v[t].color.b].join(",") +
                          ")"
                    : ((s = v[t - 1]),
                      (g = (m = v[t]).pct - s.pct),
                      (d = 1 - (u = (n - s.pct) / g)),
    ...
    function f(t, n) {
        ...
        return (
            (o = o >= i.length ? i.length - 1 : o), Math.round(t * e) / e + i[o]
        );
    }
    function s(t) {
            ...
            (n = u(n) ? n : null),
                ...
                null !== e &&
                    ...
                    o.config.minTxt
                        ...
                        ? (o.txtMinimum = f(
                              o.config.min,
                              o.config.humanFriendlyDecimal
                          ))
                        : o.config.formatNumber &&
                          (o.txtMinimum = s(o.config.min)),
                    o.config.reverse
