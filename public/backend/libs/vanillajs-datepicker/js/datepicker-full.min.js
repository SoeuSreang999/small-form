!(function () {
    ...
    const O = {
            ...
            m(e, t, i) {
                ...
                return (
                    s.setMonth(n),
                    s.getMonth() !== N(n) ? s.setDate(0) : s.getTime()
                );
            },
    ...
    function F(t) {
        ...
        return (M[t] = {
            ...
            formatter: (t, s) =>
                n.reduce((e, n, a) => e + `${i[a]}${n(t, s)}`, "") + e(i),
        });
    }
    function V(e, t, i) {
    ...
    function se(e, i) {
        ...
        "pickLevel" in s && ((D = te(s.pickLevel, m, 2)), delete s.pickLevel),
            D !== m &&
                (D > m &&
                    ("minDate" in s || (s.minDate = p),
                    "maxDate" in s || (s.maxDate = u)),
        ...
        if (
            ...
            if ("function" == typeof e)
                (n.datesDisabled = null),
                    (n.checkDisabled = (t, i) => e(new Date(t), i, r));
            else {
        ...
        if (
            (s.daysOfWeekDisabled &&
                ((n.daysOfWeekDisabled = s.daysOfWeekDisabled.reduce(G, [])),
                delete s.daysOfWeekDisabled),
            s.daysOfWeekHighlighted &&
                ((n.daysOfWeekHighlighted = s.daysOfWeekHighlighted.reduce(
                    G,
                    []
                )),
        ...
        s.dateDelimiter &&
            ((n.dateDelimiter = String(s.dateDelimiter)),
            delete s.dateDelimiter);
        let M = f;
    ...
    class ce {
        ...
        prepareForRender(e, t, i) {
            this.disabled = [];
            const s = this.picker;
            s.setViewSwitchLabel(e),
                s.setPrevButtonDisabled(t),
                s.setNextButtonDisabled(i);
        }
        setDisabled(e, i) {
        ...
        performBeforeHook(e, t) {
            ...
            if (i) {
                ...
                if ((!1 === i.enabled && this.setDisabled(t, s), i.classes)) {
                    ...
                    s.add(...e),
                        e.includes("disabled") && this.setDisabled(t, s);
                }
                i.content &&
                    (function (e, t) {
                        K(e),
        ...
        setOptions(e) {
            ...
            "getWeekNumber" in e && (this.getWeekNumber = e.getWeekNumber),
                "showDaysOfWeek" in e &&
                    (e.showDaysOfWeek
                        ? (_(this.dow),
                          this.weekNumbers && _(this.weekNumbers.dow))
                        : (W(this.dow),
            ...
            if (
                ...
                Array.from(this.weekNumbers.weeks.children).forEach((i, s) => {
                    ...
                    (i.textContent = this.getWeekNumber(n, e)),
                        s > 3 &&
                            i.classList[n > this.last ? "add" : "remove"](
                                "next"
                            );
                });
            }
    ...
    function Me(e, t) {
        ...
        n
            ...
            : ke(e, Number(1 === s ? a.month : a.year));
    }
    function Oe(e) {
        e.preventDefault();
    }
    ...
    function Ce(e, t) {
        ...
        "clearButton" in t &&
            (t.clearButton
                ? _(e.controls.clearButton)
                : W(e.controls.clearButton));
    }
    function Fe(t) {
        const { dates: i, config: s, rangeSideIndex: a } = t;
        return n(
            i.length > 0 ? e(i) : b(s.defaultViewDate, s.pickLevel, a),
            s.minDate,
            s.maxDate
        );
    }
    ...
    class Ae {
        ...
        render(e = !0) {
            ...
            if (
                ...
                t[a](),
                s &&
                    (this.main.replaceChild(t.element, s.element),
                    pe(i, "changeView")),
                !isNaN(n))
            ) {
        ...
        if ("Enter" === r) {
            if (a)
                if (n) e.exitEditMode({ update: !0, autohide: i.autohide });
                    ...
                    t.isMinView
                        ? e.setDate(s.viewDate)
                        : (s.changeView(t.id - 1).render(), l());
                }
            else e.update();
            return;
        }
    ...
    (window.Datepicker = Ue),
        (window.DateRangePicker = class {
            ...
            getDates(e = void 0) {
                const t = e
                    ? (t) => B(t, e, this.datepickers[0].config.locale)
                    : (e) => new Date(e);
