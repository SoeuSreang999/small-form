...
<head>
    ...
    <style>
        body {
            background-image: url('../backend/images/auth-bg.png');
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <a href="{{ route('google.redirect') }}" class="d-flex justify-content-center align-items-center thumb-md bg-danger-subtle text-danger rounded-circle">
