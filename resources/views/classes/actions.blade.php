<div class="dropdown d-inline-block">
    ...
    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dLabel11">
        <a class="dropdown-item text-success" href="javascript:void(0);" onclick="classEdit(this,{{ $class->id }});">
            <i class="fas fa-pencil-alt fs-12 me-1"></i>
            @lang('action.edit')
        </a>
        <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="classDelete(this,{{ $class->id }});">
