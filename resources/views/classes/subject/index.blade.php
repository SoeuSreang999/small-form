@extends('layouts.app')
@section('title', __('menu.subjects'))
    ...
    <div class="row">
        <div class="col-lg-12 ms-auto d-flex gap-4 align-items-center">
            ...
            <div class="col-auto d-flex align-items-center">
                <button class="btn btn-primary" onclick="SubjectCreate(this);">
                    <i class="fas fa-plus me-1"></i>
                    <span class="">{{ __('action.subject.add')}}</span>
                </button>
            </div>
        </div>
    </div>
...
@push('scripts')
    @include('classes.subject.script')
@endpush
