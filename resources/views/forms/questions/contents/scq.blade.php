        ...
        <div class="col-lg-12 mb-2 d-flex justify-content-between align-items-center gap-3">
            <div class="input-group">
                <div class="input-group-text">
                    <input class="form-check-input mt-0" type="radio" name="option_{{ $question->id }}[]" id="option_{{ $option->id }}" {{ ($option->is_correct??null === 1)?'checked':''  }} value="{{ $option->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Set is correct">
                </div>
