    ...
    <div class="container-fluid">
        <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">
            ...
            <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                ...
                @endphp
                <li class="ms-auto">
                    <a class="nav-link opacity-0" href="javascript:void(0);" id="auto-save-spinner">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                        Saving...
                    </a>
                </li>
                @if (Route::is('forms.index'))
                    <li class="topbar-item">
                        <a class="nav-link nav-icon" href="{{ route('forms.preview.index', $form?->uuid??null) }}"
                            target="_blank"
                            data-bs-toggle="tooltip"
                            data-bs-placement="bottom"
                            title="Preview">
                        <i class="mdi mdi-television fs-4"></i>
                        </a>
                    </li>
                @endif
                @if (Route::is('forms.index'))
                    @if (!$form?->isAssign())
                        <li class="mx-2">
                            <a class="btn btn-sm btn-primary px-3" href="javascript:void(0);" onclick="publicForm(this, '{{ $form?->uuid ?? '' }}');" role="button"
                                data-bs-toggle="tooltip"
                                data-bs-placement="bottom"
                                title="{{ __('general.public_detail') }}"
                            >
                                {{ __('general.public') }}
                            </a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    aria-haspopup="false" aria-expanded="false" data-bs-offset="0,19">
                        @if($currentLang === 'en')
                            <img src="{{ asset('backend/images/flags/en_flag.jpg')}}" alt="English" class="thumb-sm rounded-circle">
                        @elseif($currentLang === 'kh')
                            <img src="{{ asset('backend/images/flags/kh_flag.jpg')}}" alt="Khmer" class="thumb-sm rounded-circle">
                        @endif
                    </a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item @if($currentLang === 'en') active @endif" href="{{ route('lang.switch', 'en') }}">
                            <img src="{{ asset('backend/images/flags/en_flag.jpg')}}" alt="English" height="15" class="me-2">English
                        </a>
                        <a class="dropdown-item @if($currentLang === 'kh') active @endif" href="{{ route('lang.switch', 'kh') }}">
                            <img src="{{ asset('backend/images/flags/kh_flag.jpg')}}" alt="Khmer" height="15" class="me-2">Khmer
                        </a>
                    </div>
                </li>
                <li class="topbar-item">
